...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                     \
      len, qptrdiff(offsetof(qt_meta_stringdata_Tile_t, stringdata0) + ofs -   \
...
void Tile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id,
                              void **_a) {
  Q_UNUSED(_o);
  Q_UNUSED(_id);
  Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject Tile::staticMetaObject = {
    {QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
     qt_meta_stringdata_Tile.data, qt_meta_data_Tile, qt_static_metacall,
     nullptr, nullptr}};
