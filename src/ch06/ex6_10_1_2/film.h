...
class Film {
public:
  virtual QString toString(bool labeled, QString sep) const = 0;
...
public:
  Educational(QString id, QString title, QString dir, double length,
...
public:
  ...
  Entertainment(QString id, QString title, QString dir, double length,
                QDate relDate, FilmTypes type, MPAARatings rating);
  // Constructor with arguments.
