...
int main() {
  ...
  Educational *film1 = new Educational(
      QString("012341"), QString("Blue Planet"), QString("Ben Burtt"), 40.0,
      QDate(1990, 7, 13), QString("Science"), 8);
  ...
  Entertainment *film3 = new Entertainment(
      QString("056182"), QString("Old School"), QString("Todd Phillips"), 90.0,
      QDate(2003, 2, 21), Entertainment::Action, Entertainment::PG13);
  propList.clear();
  propList << "051234" << "12 Monkeys" << "Terry Gilliam" << "129.0"
           << "Fri Dec 29 1995"
           << "SciFi" << "PG-13";
  ...
  // Output film list.
  cout << "Film list contains the following movies: " << endl
       << endl
       << list.toString() << endl;
