...
QString Student::getClassName() const { return "Student"; }

QString Student::toString() const {
  QString retval;
  QTextStream os(&retval);
  os << "[" << getClassName() << "]"
     << " name: " << m_Name << "; Id: " << m_StudentId
     << "; Year: " << yearStr() << "; Major: " << m_Major;
  return retval;
}

int Student::getYear() const { return m_Year; }
...
QString GradStudent::getClassName() const { return "GradStudent"; }
